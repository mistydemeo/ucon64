...
{
  char header[GD_HEADER_LEN], dest_name[FILENAME_MAX], *p;
...
/*
  The only way to determine if a HiROM dump is interleaved or not seems to be
  to check the value of the map type byte. Valid HiROM values (hexadecimal):
  21, 31, 35, 3a
  Valid LoROM values:
