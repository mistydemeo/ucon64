...
pcengine_init (st_rominfo_t *rominfo)
{
  ...
  */
  ...
  if (q_fncmp (ucon64.rom, rominfo->buheader_len, 500, "\x94\x02\x0f", 3, 0) != -1 ||
      q_fncmp (ucon64.rom, rominfo->buheader_len, 500, "\x94\x02\x01", 3, 0) != -1)
#else
  if (change_mem ((char *) rom_buffer, 500, "\x94\x02\x0f", 3, 0, 0, "\x0f", 1, 0) > 0 ||
      change_mem ((char *) rom_buffer, 500, "\x94\x02\x01", 3, 0, 0, "\x01", 1, 0) > 0)
#endif
    swapped = 1;
